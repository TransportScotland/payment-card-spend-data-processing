...
def convert_row(split, census_dict) -> list:
    ...
    # perc_rail_users	jour_purpose	pan_cnt	txn_cnt	txn_gbp_amt	Day_of_week
...
db_creation_string_columns = str(
            ...
            "perc_rail_users Float32 NOT NULL,"
            "jour_purpose String NOT NULL,"
            ...
            ") ENGINE = MergeTree() "
            "ORDER BY (time_frame, merchant_location, jour_purpose, day_of_week)"
)
